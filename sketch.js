...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope2 = new Rope(7,{x:490,y:90});
    ...
    starDisp = createSprite(50,20,30,30);
    starDisp.scale=0.2;
    starDisp.addAnimation("empty",empty_star);
    starDisp.addAnimation("one",one_star);
    starDisp.addAnimation("two",two_star);
    starDisp.changeAnimation("empty");
...
function draw() 
{
  ...
  if(star1col==true&&star2col==true){
    starDisp.changeAnimation("two");
  } else if(star1col==true||star2col==true){
    starDisp.changeAnimation("one");
  }
